...
function Welcome() {
  return (
    <Flex mt="4" w="100%" alignItems="center" justifyContent="center" h="432px" direction="column">
      <Flex direction="column" h="432px" flexDirection="column" alignItems="center" w="380px">
      ...
      <Flex alignItems="center" justifyContent="center" w="300px" h="80px" mt="10">
